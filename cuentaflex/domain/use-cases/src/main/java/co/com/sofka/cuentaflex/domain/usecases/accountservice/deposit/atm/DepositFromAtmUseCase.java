package co.com.sofka.cuentaflex.domain.usecases.accountservice.deposit.atm;
...
public final class DepositFromAtmUseCase implements UseCase<UnidirectionalTransactionRequest, ResultWith<TransactionDoneResponse>> {
    ...
    public DepositFromAtmUseCase(FeesValues feesValues, AccountRepository accountRepository, BusPort busPort) {
